...
function modifier_mjz_lina_laguna_blade_bonus:IsBuff() return true end
function modifier_mjz_lina_laguna_blade_bonus:IsPermanent() return true end
...
function modifier_mjz_lina_laguna_blade_bonus:DeclareFunctions()
    local funcs = {
...
function modifier_mjz_lina_laguna_blade_creature:IsHidden() return true end
function modifier_mjz_lina_laguna_blade_creature:IsPermanent() return true end
function modifier_mjz_lina_laguna_blade_creature:IsPurgable() return false end
function modifier_mjz_lina_laguna_blade_creature:RemoveOnDeath() return false end
...
if IsServer() then
    ...
    function modifier_mjz_lina_laguna_blade_death:OnCreatureDeath( target )
        local owner = self:GetCaster()
        local ability = self:GetAbility()
        local victim = target
        local can_charge = false
        ...
        local modifier_creature_name = 'modifier_mjz_lina_laguna_blade_creature'
