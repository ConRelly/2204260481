modifier_generic_orb_effect_v1_0 = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_generic_orb_effect_v1_0:IsHidden() return true end

function modifier_generic_orb_effect_v1_0:IsDebuff() return false end

function modifier_generic_orb_effect_v1_0:IsPurgable() return false end

--------------------------------------------------------------------------------
-- Initializations
function modifier_generic_orb_effect_v1_0:OnCreated( kv )
	-- generate data
...
function modifier_generic_orb_effect_v1_0:OnRefresh( kv )
end

function modifier_generic_orb_effect_v1_0:OnDestroy( kv )

end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_generic_orb_effect_v1_0:DeclareFunctions()
	local funcs = {
...
function modifier_generic_orb_effect_v1_0:OnAttack( params )
...
function modifier_generic_orb_effect_v1_0:GetModifierProcAttack_Feedback( params )
	if self.records[params.record] then
		-- apply the effect
		if self.ability.OnOrbImpact then self.ability:OnOrbImpact( params ) end
	end
end
function modifier_generic_orb_effect_v1_0:OnAttackFail( params )
	if self.records[params.record] then
		-- apply the fail effect
		if self.ability.OnOrbFail then self.ability:OnOrbFail( params ) end
	end
end
function modifier_generic_orb_effect_v1_0:OnAttackRecordDestroy( params )
	-- destroy attack record
	self.records[params.record] = nil
end

function modifier_generic_orb_effect_v1_0:OnOrder( params )
...
function modifier_generic_orb_effect_v1_0:GetModifierProjectileName( params )
	if self.ability.GetProjectileName then
...
--------------------------------------------------------------------------------
-- Helper: Flags
function modifier_generic_orb_effect_v1_0:FlagExist(a,b)--Bitwise Exist
	local p,c,d=1,0,b
