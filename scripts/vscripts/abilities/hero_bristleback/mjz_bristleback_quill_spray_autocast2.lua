...
local TARGET_ABILITY_NAME_2 = "oracle_purifying_flames"
local MODIFIER_NAME = 'modifier_mjz_bristleback_quill_spray_autocast'
local THIS_LUA = "abilities/hero_bristleback/mjz_bristleback_quill_spray_autocast2.lua"

LinkLuaModifier(MODIFIER_NAME, THIS_LUA, LUA_MODIFIER_MOTION_NONE)

---------------------------------------------------------------------------

mjz_bristleback_quill_spray_autocast2 = class({})
local ability_class = mjz_bristleback_quill_spray_autocast2
...
function modifier_class:OnIntervalThink()
    if IsServer() then
        ...
        local radius_auto = 1650 + caster:GetCastRangeBonus()
