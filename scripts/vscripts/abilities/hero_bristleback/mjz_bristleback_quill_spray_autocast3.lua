...
local MODIFIER_NAME = 'modifier_mjz_bristleback_quill_spray_autocast3'
local THIS_LUA = "abilities/hero_bristleback/mjz_bristleback_quill_spray_autocast3.lua"

LinkLuaModifier(MODIFIER_NAME, THIS_LUA, LUA_MODIFIER_MOTION_NONE)

---------------------------------------------------------------------------

mjz_bristleback_quill_spray_autocast3 = class({})
local ability_class = mjz_bristleback_quill_spray_autocast3
...
modifier_mjz_bristleback_quill_spray_autocast3 = class({})
local modifier_class = modifier_mjz_bristleback_quill_spray_autocast3

function modifier_class:IsPassive() return false end
function modifier_class:IsHidden() return true end
function modifier_class:IsPurgable() return false end
function modifier_class:ResetToggleOnRespawn() return true end
...
function modifier_class:OnIntervalThink()
    ...
    local radius_auto = 1000 + caster:GetCastRangeBonus()
...
function modifier_class:CanCastAbility(target_ability)
    ...
    local caster = self:GetCaster()
    local parent = self:GetParent()
    local target_ability = parent:FindAbilityByName(TARGET_ABILITY_NAME_2)
