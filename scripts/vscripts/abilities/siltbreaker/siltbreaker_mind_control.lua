...
LinkLuaModifier( "modifier_siltbreaker_mind_control", "modifiers/siltbreaker/modifier_siltbreaker_mind_control", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_siltbreaker_mind_control_marked", "modifiers/siltbreaker/modifier_siltbreaker_mind_control_marked", LUA_MODIFIER_MOTION_NONE )
