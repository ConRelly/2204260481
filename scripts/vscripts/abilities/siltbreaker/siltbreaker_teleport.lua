...
LinkLuaModifier( "modifier_siltbreaker_teleport_thinker", "modifiers/siltbreaker/modifier_siltbreaker_teleport_thinker", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_temple_guardian_immunity", "modifiers/siltbreaker/modifier_temple_guardian_immunity", LUA_MODIFIER_MOTION_NONE )
