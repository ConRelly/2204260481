LinkLuaModifier( "modifier_darkrider_time_aura", "abilities/custom/darkrider_time_aura.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_darkrider_time_aura_aura", "abilities/custom/darkrider_time_aura.lua", LUA_MODIFIER_MOTION_NONE )
