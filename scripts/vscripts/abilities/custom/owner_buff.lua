...
if not owner_buff then
	owner_buff = class({})
end
function owner_buff:GetIntrinsicModifierName()
	return "modifier_owner_buff"
end
if not modifier_owner_buff then
	modifier_owner_buff = class({})
end
function modifier_owner_buff:IsHidden()
	return false
end
