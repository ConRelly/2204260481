...
function back_in_time:GetIntrinsicModifierName()
  return "modifier_back_in_time"
end
...
function modifier_back_in_time:GetPriority()
...
function modifier_back_in_time_buff:IsHidden() return false end
...
function modifier_back_in_time_buff:GetModifierBonusStats_Strength()
  return self:GetStackCount() * self:GetAbility():GetSpecialValueFor("str_stack")
end

function modifier_back_in_time_buff:GetModifierBonusStats_Agility()
  return self:GetStackCount() * self:GetAbility():GetSpecialValueFor("agi_stack")
end  
...
function modifier_back_in_time_buff:GetModifierHealthBonus()
  return self:GetStackCount() * self:GetAbility():GetSpecialValueFor("hp_stack")
end 

function modifier_back_in_time_buff:GetModifierMoveSpeedBonus_Constant()
  return self:GetStackCount() * self:GetAbility():GetSpecialValueFor("ms_stack")
end
...
function modifier_class:GetModifierAura()
	return "modifier_back_in_time_aura_effect"
end
