...
LinkLuaModifier ("modifier_darkrider_heartbeat", "abilities/custom/darkrider_heartbeat.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier ("modifier_darkrider_heartbeat_aura", "abilities/custom/darkrider_heartbeat.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_darkrider_heartbeat_aura:GetAuraSearchFlags() return DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES end
