if world_devour == nil then world_devour = class({}) end

function world_devour:GetAbilityTextureName()
...
function world_devour:GetBehavior()
  return DOTA_ABILITY_BEHAVIOR_NO_TARGET
end

function world_devour:GetCooldown( nLevel )
  return self.BaseClass.GetCooldown( self, nLevel )
end

function world_devour:OnSpellStart()
  if IsServer() then
...
function world_devour:CreateExplosion(caster)
