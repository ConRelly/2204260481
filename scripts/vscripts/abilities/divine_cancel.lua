...
LinkLuaModifier("modifier_cancels_count", "abilities/divine_cancel.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_divine_cancel", "abilities/divine_cancel.lua", LUA_MODIFIER_MOTION_NONE)
