function scepter(keys)
	...
	if caster:HasScepter() then
		...
		local skeleton = CreateUnitByName("npc_dota_clinkz_skeleton_archer_frostivus20182", p3, true, caster, caster:GetOwner(),caster:GetTeamNumber())
		local skeleton2 = CreateUnitByName("npc_dota_clinkz_skeleton_archer_frostivus20182", p2, true, caster, caster:GetOwner(),caster:GetTeamNumber())
