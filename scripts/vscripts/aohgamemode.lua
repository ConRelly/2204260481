...
function AOHGameMode:InitGameMode()
	...
	GameRules:GetGameModeEntity():SetMaximumAttackSpeed(1300)
	GameRules:GetGameModeEntity():SetCustomAttributeDerivedStatValue(DOTA_ATTRIBUTE_AGILITY_ATTACK_SPEED,0.07)
