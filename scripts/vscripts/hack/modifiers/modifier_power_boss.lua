...
-- function modifier_power_boss:GetModifierPercentageCooldown()
--     return 10
-- end

-- function modifier_power_boss:GetModifierTotalPercentageManaRegen()
-- 	return 0.5
-- end

function modifier_power_boss:GetModifierTotalDamageOutgoing_Percentage( )
    return 20       -- 伤害增强20%
end

function modifier_power_boss:GetModifierStatusResistanceStacking()
	return 26       -- 状态抗性 40%
end

function modifier_power_boss:GetModifierIncomingDamage_Percentage()
    return -6      -- 伤害减少10%
end
