...
function modifier_power_boss:GetModifierMagicalResistanceBonus() return 40 end
function modifier_power_boss:GetModifierPhysicalArmorBonus() return 50 end
function modifier_power_boss:GetModifierExtraHealthPercentage() return 150 end
