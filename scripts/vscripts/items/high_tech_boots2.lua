...
function item_high_tech_boots2:GetIntrinsicModifierName()
    return "modifier_item_high_tech_boots2"
end
...
function modifier_item_high_tech_boots2_active:IsHidden()
    return false
end

function modifier_item_high_tech_boots2_active:IsPurgable()
	return false
end

function modifier_item_high_tech_boots2_active:GetTexture()
    return "speedsters"
end
...
function modifier_item_high_tech_boots2_active:OnCreated()
...
function modifier_item_high_tech_boots2:IsHidden()
    return true
end
function modifier_item_high_tech_boots2:IsPurgable()
	return false
end

function modifier_item_high_tech_boots2:GetAttributes()
...
function modifier_item_high_tech_boots2:GetModifierIgnoreMovespeedLimit()
	return 1
end	
...
function modifier_item_high_tech_boots2:GetModifierTurnRate_Override()
	return 1
end	
...
function modifier_item_high_tech_boots2_effect:IsHidden()
    return true
end
...
function modifier_item_high_tech_boots2_effect:GetEffectAttachType()
