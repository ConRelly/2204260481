...
--				ECHO SABRE
-------------------------------------------
LinkLuaModifier("modifier_imba_echo_sabre", "citems/custom/item_echo_sabre.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_imba_echo_sabre_passive", "items/custom/item_echo_sabre.lua", LUA_MODIFIER_MOTION_NONE)
-------------------------------------------
...
--				REVERB RAPIER
-------------------------------------------
LinkLuaModifier("modifier_imba_reverb_rapier_passive", "items/custom/item_echo_sabre.lua", LUA_MODIFIER_MOTION_NONE)
-------------------------------------------
