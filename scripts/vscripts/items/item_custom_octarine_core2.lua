LinkLuaModifier("modifier_item_custom_octarine_core", "items/item_custom_octarine_core2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_custom_octarine_core_reduction", "items/item_custom_octarine_core2.lua", LUA_MODIFIER_MOTION_NONE)
...
function item_custom_octarine_core2:GetIntrinsicModifierName()
...
function modifier_item_custom_octarine_core:AllowIllusionDuplicate()
	return true
end	
function modifier_item_custom_octarine_core:RemoveOnDeath()
	return false
end
function modifier_item_custom_octarine_core:GetTexture()
	return "bigan_octarine_core_edible"
end
