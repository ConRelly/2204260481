...
function item_mjz_devils_veil:GetIntrinsicModifierName()
    return "modifier_item_mjz_devils_veil"
end
...
function modifier_item_mjz_devils_veil:GetAttributes()
...
function modifier_item_mjz_devils_veil_buff:GetTexture()
	return "item_mjz_devils_veil"
end
