...
function luna_eclipse_lua:OnSpellStart()
	...
	if self.damage then
		...
		if ability and ability:GetLevel()>0 then
			damage = ability:GetTalentSpecialValueFor("beam_damage") + (caster:GetAgility() * ability:GetTalentSpecialValueFor("agi_multiplier")) -- zero-based
		end
	end
	...
	-- begin night
	GameRules:BeginTemporaryNight( 13 )
end
end
