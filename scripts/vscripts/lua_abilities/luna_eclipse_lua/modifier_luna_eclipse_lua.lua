...
function modifier_luna_eclipse_lua:PlayEffects1()
	-- Get Resources
	local particle_cast = "particles/econ/items/luna/luna_lucent_ti5_gold/luna_eclipse_cast_moonfall_gold.vpcf" --"particles/units/heroes/hero_luna/luna_eclipse.vpcf"  --
